          ...
          <g className="model-davi">
            ...
            >
              ...
              <text
                ...
                className="label_icon_state"
                x={365}
                y={216}
              >
                BA
              </text>
              <text id="label_state_ba" className="label_state" x={419} y={15}>
                Bahia
              </text>
            </a>
            <a href="#" id="state_se" className="state" data-state="se">
              ...
              <text id="label_state_se" className="label_state" x={405} y={15}>
                Sergipe
              </text>
            </a>
            <a href="#" id="state_pe" className="state" data-state="pe">
              ...
              <text id="label_state_pe" className="label_state" x={372} y={15}>
                Pernambuco
              </text>
            </a>
            <a href="#" id="state_al" className="state" data-state="al">
              ...
              <text id="label_state_al" className="label_state" x={403} y={15}>
                Alagoas
              </text>
            </a>
            <a href="#" id="state_am" className="state" data-state="am">
              ...
              <text id="label_state_am" className="label_state" x={388} y={15}>
                Amazonas
              </text>
            </a>
            <a href="#" id="state_pa" className="state" data-state="pa">
              ...
              <text id="label_state_pa" className="label_state" x={426} y={15}>
                Pará
              </text>
            </a>
            <a href="#" id="state_mt" className="state" data-state="mt">
              ...
              <text id="label_state_mt" className="label_state" x={369} y={15}>
                Mato Grosso
              </text>
            </a>
            <a href="#" id="state_ro" className="state" data-state="ro">
              ...
              <text id="label_state_ro" className="label_state" x={392} y={15}>
                Rondônia
              </text>
            </a>
            <a href="#" id="state_ac" className="state" data-state="ac">
              ...
              <text id="label_state_ac" className="label_state" x={426} y={15}>
                Acre
              </text>
            </a>
            <a href="#" id="state_ap" className="state" data-state="ap">
              ...
              <text id="label_state_ap" className="label_state" x={412} y={15}>
                Amapá
              </text>
            </a>
            <a href="#" id="state_rj" className="state" data-state="rj">
              ...
              <text id="label_state_rj" className="label_state" x={358} y={15}>
                Rio de Janeiro
              </text>
            </a>
            <a href="#" id="state_rs" className="state" data-state="rs">
              ...
              <text id="label_state_rs" className="label_state" x={333} y={15}>
                Rio Grande do Sul
              </text>
            </a>
            <a href="#" id="state_sc" className="state" data-state="sc">
              ...
              <text id="label_state_sc" className="label_state" x={359} y={15}>
                Santa Catarina
              </text>
            </a>
            <a href="#" id="state_pr" className="state" data-state="pr">
              ...
              <text id="label_state_pr" className="label_state" x={412} y={15}>
                Paraná
              </text>
            </a>
            <a href="#" id="state_sp" className="state" data-state="sp">
              ...
              <text id="label_state_sp" className="label_state" x={391} y={15}>
                São Paulo
              </text>
            </a>
            <a href="#" id="state_ms" className="state" data-state="ms">
              ...
              <text id="label_state_ms" className="label_state" x={322} y={15}>
                Mato Grosso do Sul
              </text>
            </a>
            <a href="#" id="state_go" className="state" data-state="go">
              ...
              <text id="label_state_go" className="label_state" x={421} y={15}>
                Goiás
              </text>
            </a>
            <a href="#" id="state_mg" className="state" data-state="mg">
              ...
              <text id="label_state_mg" className="label_state" x={369} y={15}>
                Minas Gerais
              </text>
            </a>
            <a href="#" id="state_es" className="state" data-state="es">
              ...
              <text id="label_state_es" className="label_state" x={362} y={15}>
                Espírito Santo
              </text>
            </a>
            <a href="#" id="state_pi" className="state" data-state="pi">
              ...
              <text id="label_state_pi" className="label_state" x={424} y={15}>
                Piauí
              </text>
            </a>
            <a href="#" id="state_ce" className="state" data-state="ce">
              ...
              <text id="label_state_ce" className="label_state" x={420} y={15}>
                Ceará
              </text>
            </a>
            <a href="#" id="state_rr" className="state" data-state="rr">
              ...
              <text id="label_state_rr" className="label_state" x={402} y={15}>
                Roraima
              </text>
            </a>
            <a href="#" id="state_to" className="state" data-state="to">
              ...
              <text id="label_state_to" className="label_state" x={391} y={15}>
                Tocantins
              </text>
            </a>
            <a href="#" id="state_ma" className="state" data-state="ma">
              ...
              <text id="label_state_ma" className="label_state" x={390} y={15}>
                Maranhão
              </text>
            </a>
            <a href="#" id="state_rn" className="state" data-state="rn">
              ...
              <text id="label_state_rn" className="label_state" x={317} y={15}>
                Rio Grande do Norte
              </text>
            </a>
            <a href="#" id="state_pb" className="state" data-state="pb">
              ...
              <text id="label_state_pb" className="label_state" x={407} y={15}>
                Paraíba
              </text>
            </a>
            <a href="#" id="state_df" className="state" data-state="df">
              ...
              <text id="label_state_df" className="label_state" x={350} y={15}>
                Distrito Federal
              </text>
            </a>
          </g>
