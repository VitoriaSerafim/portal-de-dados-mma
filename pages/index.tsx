    ...
    <>
      ...
      >
        ...
        <main className="text-black text-center items-center">
          ...
          <h1 className="mb-4 text-4xl font-extrabold leading-none tracking-tight text-black md:text-5xl lg:text-6xl"> Bem-vindo ao Portal de Dados AnimalCrossing</h1>
          <p className="mb-6 text-lg font-normal text-gray-500 lg:text-xl sm:px-16 xl:px-48 "> Um portal para fácil acesso dos dados fornecidos palo Ministerio do
            Meio Ambiente do Brasil</p>
